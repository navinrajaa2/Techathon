  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-3 sm:p-4 bg-slate-900/50 backdrop-blur-sm animate-fadeIn">
      <div className="bg-white border border-slate-200 rounded-3xl w-full max-w-4xl max-h-[92vh] flex flex-col shadow-2xl overflow-hidden">
        ...
        {/* Header */}
        <div className="p-5 border-b border-slate-200 bg-gradient-to-r from-blue-50 via-indigo-50 to-white flex items-center justify-between">
            ...
            <div>
              <div className="flex items-center space-x-2">
                ...
                <span className="text-xs font-bold text-slate-500">
                  Level {currentLevel} → Level {targetLevel} Verification
                </span>
              </div>
              <h2 className="text-lg font-black text-slate-900 font-outfit mt-0.5">
        ...
        {/* Tab Navigation */}
        <div className="flex items-center space-x-2 px-6 pt-3 border-b border-slate-100 bg-white text-xs font-bold">
          <button
          ...
          >
            ...
            <span>1. Project Brief & Rubric</span>
          </button>
          ...
          >
            ...
            <span>2. Submission Workspace</span>
          </button>
          ...
          >
            ...
            <span>3. AI Verification Results</span>
            {verificationResult && (
        ...
        <div className="flex-1 overflow-y-auto p-6 space-y-6">
          ...
          {activeTab === 'brief' && (
            <div className="space-y-6 animate-fadeIn">
              ...
              {/* Scenario Card */}
              <div className="p-5 rounded-2xl bg-gradient-to-br from-blue-50 to-indigo-50 border border-blue-200/80 space-y-3">
            ...
            <div className="space-y-5 animate-fadeIn">
              ...
              <div className="pt-2 flex items-center justify-between">
                ...
                <button
                  ...
                  className="px-6 py-2.5 rounded-xl bg-gradient-to-r from-blue-600 to-indigo-600 hover:from-blue-700 hover:to-indigo-700 text-white text-xs font-bold flex items-center space-x-2 shadow-md shadow-blue-500/20 transition active:scale-95 disabled:opacity-40"
                >
            ...
            <div className="space-y-6 animate-fadeIn">
              ...
              {isEvaluating ? (
                ...
                <div className="space-y-6">
                  ...
                  <div className="p-5 rounded-2xl bg-gradient-to-r from-emerald-500/10 via-teal-500/10 to-blue-500/10 border border-emerald-300 flex items-center justify-between">
                    <div className="flex items-center space-x-3">
